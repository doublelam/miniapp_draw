 ...
 */
declare function Page(page: IPage<any>): void;
...
declare namespace wx {
     ...
     */
    export function canvasGetImageData(obj: {
        canvasId: string;
        x: number;
        y: number;
        width: number;
    ...
    export interface SelectorQuery {
        in: (objectComponent: IPage<any>) => SelectorQuery;
...
interface NodesRef {
    boundingClientRect: (callback: (res: Rect) => void) => CommonExec;
